...
const gettingStartedItems = [
	{
		icon: <Heart size={24} />,
		title: "Grow in Faith",
		description: "Deepen your relationship with God through Bible study, prayer, and worship.",
		cta: "Join a Life Group",
		href: "/about",
	},
	{
		icon: <Users size={24} />,
		title: "Connect with Community",
		description: "Find your place in a welcoming family that supports and uplifts one another.",
		cta: "Discipleship Class",
		href: "/about",
	},
	{
		icon: <Target size={24} />,
		title: "Serve Others",
		description: "Use your gifts to make a difference in Gulu and across Uganda.",
		cta: "Ministry Sign-Up",
		href: "/contact",
	},
];
...
export default function Home() {
	...
	return (
      ...
      <HeroSection />
			...
			{/* ═══════════════════════════════════════════════
			    4. CORE IDENTITY SECTION
			═══════════════════════════════════════════════ */}
			{/* <section className="relative py-28 sm:py-36 px-4 sm:px-6 overflow-hidden">
				<div className="absolute inset-0 z-0">
					<Image src="/community.png" alt="GBCC Community" fill className="object-cover opacity-20 dark:opacity-10" />
					<div className="absolute inset-0 bg-gradient-to-r from-white/90 via-white/70 to-white/90 dark:from-[#020617]/90 dark:via-[#020617]/70 dark:to-[#020617]/90" />
				</div>
				...
				<div className="max-w-5xl mx-auto relative z-10 text-center">
					<motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}>
						...
						>
							Christ-like People.
							<br />
							<span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-blue to-brand-blue/60">
								Transforming Society.
							</span>
						</motion.h2>
						<motion.p variants={fadeUp} className="text-lg md:text-xl text-slate-500 dark:text-slate-400 max-w-2xl mx-auto font-medium">
